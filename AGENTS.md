...
| 當你要... | 請先讀取 |
|---|---|
| **每次 session 開始** | .Codex/skills/SESSION_START_SKILL.md |
| 任務涉及多個獨立模組或超過 5 個檔案 | .Codex/skills/PARALLEL_AGENT_SKILL.md |
| 建立新元件或頁面 | .Codex/skills/COMPONENT_SKILL.md |
| 修改或新增樣式 | .Codex/skills/UI_SKILL.md |
| 新增 Redux slice | .Codex/skills/REDUX_SKILL.md |
| 新增 API 函式 | .Codex/skills/API_SKILL.md |
| 建立表單元件 | .Codex/skills/FORM_SKILL.md |
| 撰寫測試 | .Codex/skills/TEST_SKILL.md |
